...
////
////AttributiveCellTableModel继续于DefaultTableModel，最关键的东西在这里，CellAttribute，他的实现是交给DefaultCellAttribute这个对象的，这个是存储单元格合并信息的地方，
////而且也是MultiSpanCellTable在计算的重要数据，和MultiSpanCellTableUI绘制的核心数据之一。DefaultCellAttribute有三个接口分别对应表格的功能。
////
