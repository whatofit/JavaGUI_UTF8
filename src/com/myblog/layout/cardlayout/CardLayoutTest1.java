package com.myblog.layout.cardlayout;
...

    {
...

        {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                card.previous(pane); // card布局管理器自身具有一些方法可以直接调用
        ...
        this.getContentPane().add(p, BorderLayout.SOUTH);// 按钮p
