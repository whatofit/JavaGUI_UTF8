...
public class MultiColumHeaderTable extends JTable {

	public MultiColumHeaderTable() {
	...
	private class UI extends BasicTableHeaderUI {
		...
		public void paint(Graphics g, JComponent c) {
			...
			getTableHeader().setPreferredSize(new Dimension(MultiColumHeaderTable.this.getWidth(), 45));// 设置表头大小。横坐标必须足够大，否则会出现绘制不完全以及闪烁现象
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new JScrollPane(new MultiColumHeaderTable()));
